...
2. Run each SQL file in `supabase/migrations/` in filename order in the SQL editor.
   The current app requires migrations `002` through `011`; do not deploy API
...
6. Apply migrations `006` through `011`, configure Telegram credentials, and enable alerts in Settings.
