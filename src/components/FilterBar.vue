...
<template>
  <div class="filter-controls">
    ...
    >
      <span>Filters</span>
      <span>{{ activeCount || 'All' }}</span>
    </button>

    <form id="board-filters" class="filter-bar" :class="{ 'is-open': expanded }" @submit.prevent>
      ...
      <label class="filter-field">
        <span>Profile</span>
        <select v-model="filters.eligibility">
          <option value="">All opportunities</option>
          <option value="target">Target matches</option>
